...
from gui.dialogs import ControlPanel, SaveWidget, EditMetadataWidget, DetectorShapeWidget, TitleBar
from gui.gui_utils import datacube_selector
...
class DataViewer(QtWidgets.QMainWindow):
    ...
    def __init__(self, argv):
        ...
        self.main_window.setStyleSheet(qdarkstyle.load_stylesheet() + open('gui/style.css', 'r').read())
    ...
    def setup_control_widget(self):
        ...
        self.titleBar.openDM_stems.triggered.connect(lambda: self.load_file(4))
    ...
    def load_file(self,mode,filePath=None):
        ...
        if mode == 0:
            ...
            self.datacube, _ = read(fname, ft='dmstems')
